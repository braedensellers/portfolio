    ...
    >
      ...
      <SwiperSlide className="rounded-xl bg-slate-900 border-white/10 border hover:border-amber-300 transition-all duration-300 group">
        <CarouselSlide
          ...
          description="A fully integrated personal assistant platform that consolidates financial tracking, health metrics, productivity tools, and AI-driven insights into one cohesive application."
          skills={["Next.js", "AI", "Machine Learning", "Supabase"]}
          githubLink="#"
          projectLink="#"
